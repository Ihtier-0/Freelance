...
QMatrix4x4 Camera::viewMatrix()
{
    ...
    QMatrix4x4 ClipMatrix = this -> clipMatrix();

    QMatrix4x4 viewMatrix = ClipMatrix * transferMatrix * rotateMatrix * scaleMatrix;
...
void Camera::setSize(const qreal &a_width, const qreal &a_hight)
{
    m_width = a_width;
    m_hight = a_hight;
}
